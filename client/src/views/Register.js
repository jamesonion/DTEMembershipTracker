...
export default class Register extends Component {
  ...
  onSubmit = (e) => {
    ...
    axios
      .post("http://dte-membership-tracker-app.herokuapp.com/users/add", user) // TODO: When deploying need to make this the web address. Can set the address via environment variables.
